    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Offers</h3>
            </div>
        </div>
    </div>
    <div class="notification-section shadow p-5 rounded-15 my-4">
        ...
        <div class="row">
            <div class="col-md-12 pt-5 table-responsive">
                <Table @page-changed="fetch" :fields="tableFields" :data="offers">
                    <table-search 
                        show-date-ranges
                        ...
                        <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <router-link :to="{ name : 'admin.offers.show',params : {id : item.id} }" class="dropdown-item mb-1"><i class="fa fa-eye"></i>View</router-link>
