                        ...
                        <div class="fieldData col-md-9 d-flex flex-wrap">
                            <div class="col-md-12 my-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input"   v-model="promo.registration" type="checkbox" id="registration">
                                    <label class="form-check-label" for="registration">Registration</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input  v-model="promo.smiles"  class="form-check-input" type="checkbox" id="smiles" value="option1">
                                    <label class="form-check-label" for="smiles">Smiles</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input  v-model="promo.boosts"  class="form-check-input" type="checkbox" id="boosts" value="option2">
                                    <label class="form-check-label" for="boosts">Boosts</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input  v-model="promo.reports"  class="form-check-input" type="checkbox" id="reports" value="option2">
                                    <label class="form-check-label" for="reports">Reports</label>
                                </div>
                            </div>
                            <div class="d-flex flex-wrap my-3 w-100" v-if="promo.registration" >
                            ...
                            <div class="d-flex flex-wrap my-3 w-100" v-if="promo.smiles">
                                <div class="labelTitle col-md-4">
                            ...
                            <div class="d-flex flex-wrap my-3 w-100" v-if="promo.boosts">
                                <div class="labelTitle col-md-4">
                            ...
                            <div class="d-flex flex-wrap my-3 w-100" v-if="promo.reports" >
                                <div class="labelTitle col-md-4">
    ...
    methods: {
        ...
        async create() {
            ...
            this.buildFormData(fd, this.form);
             ...
             fd.append('promo_for',JSON.stringify(this.promo));
            let params = {
                route: route('admin.promotionals.update' , {id} ),
                method: 'POST',
                data: fd,
            };
            try {
         ...
         async fetch() {
            ...
            var arr_type = [];
            this.promotional.business_types.map(function(value, key) {
            let type = { 'id' :value.id , 'name' :value.name };
                    arr_type.push(type);
            });
            var arr_name = [];
            this.promotional.business_names.map(function(value, key) {
            let name = { 'id' :value.id , 'business_name' :value.business_name };
                    arr_name.push(name);
            });
            this.form = this.promotional;
            this.form.selectedBusinessesType = arr_type;
            this.form.selectedBusinesses = arr_name;
            this.promo.registration = JSON.parse(this.promotional.promo_for.registration) ;
            this.promo.smiles = JSON.parse(this.promotional.promo_for.smiles) ;
            this.promo.boosts = JSON.parse(this.promotional.promo_for.boosts) ;
            this.promo.reports = JSON.parse(this.promotional.promo_for.reports) ;
        },
