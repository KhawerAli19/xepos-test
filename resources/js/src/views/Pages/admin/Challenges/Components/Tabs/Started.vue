      ...
      <div class="col-md-6">
        <div class="attendentContent">
          ...
          <div
            ...
            "
          >
            <h2 class="poppins">{{totalStarted}} started</h2>
          </div>
          <div
            class="
              d-flex
            ...
            "
          >
            <h2 class="poppins">+{{totalWeekStarted}} new this week</h2>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="attendeRight">
          ...
          >
            <div class="d-flex justify-content-center align-items-end">
              <div class="g-men">
                <p class="text-dark">
                  {{totalMaleStartedPecentage}}% <span class="text-secondary">Men</span>
                </p>
              </div>
              <div class="gender text-center">
                <h4 class="poppins">GENDER</h4>
                <figure>
                  <pie-chart :chartData="startedGenderData"/>
                </figure>
              </div>
              <div class="g-women">
                <p class="text-dark">
                  {{totalFemaleStartedPecentage}}% <span class="text-secondary">Women</span>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <figure>
              <bar-chart :chartData="startedAgeRangeData"/>
            </figure>
          </div>
          <div
            class="
          ...
          >
            ...
            >
              ...
              <bar-chart :chartData="startedNationalitiesData"/>
          </div>
        </div>
      </div>
    </div>
