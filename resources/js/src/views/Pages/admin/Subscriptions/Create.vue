                        ...
                        <div class="card subscriber-card subscriber-card-edit rounded-10">
                            <div class="card-header px-4 bg-transparent text-center subscriber-avatar">
                                <h3 class="text-uppercase text-white">
                                    <input type="text" class="form-control text-uppercase text-center fw-medium" name="" id="" v-model="form.package_name">
                                </h3>
                                <h4 class="text-uppercase text-white mt-3 fw-light">{{plans.duration}}</h4>
                            </div>
                            <div class="card-body py-0 px-4 px-lg-4 px-xxl-5">
                                <h4 class="card-title text-center mt-4 mb-4">
                                    <input type="text" class="form-control text-center fw-medium" name="" id="" v-model="form.package_amount">
                                </h4>
                                <ul class="p-0 m-0 subs-list">
                                    <li><i class="fa fa-check-circle"></i>{{plans.description}}</li>
                            ...
                            <div class="card-footer border-0 bg-transparent text-center">
                                <div class="d-block">
                                   <button type="submit" data-bs-toggle="modal" data-bs-target=".subscription-updated" class="btn btn-primary d-inline-block m-1">Update</button>
                                    <a @click="$router.go(-1)" class="btn btn-blue d-inline-block m-1">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
