                                ...
                                <div class="media-body flex-grow-1 ps-0 mb-3">
                                    <div class="row mb-3 mb-lg-5">
                                        ...
                                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                                            <p>{{detail.user_subscription_count > 0 ? 'Subscriber' : 'Free User'}}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3 mb-lg-5">
                                        <div class="col-12 col-lg-4 col-xl-4 col-xxl-3 lablename">
                                    ...
                                    <div class="row mb-3 mb-lg-5">
                                        ...
                                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                                            <p>{{detail.user_type == 'patient' ? 'Me' : 'My Love Once'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 mb-lg-5">
                                        ...
                                        <div class="col-12 col-lg-8 col-xl-6 col-xxl-5">
                                            <p>{{detail.user_profile.location}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="logs-tabs">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-medicine" role="tabpanel" aria-labelledby="pills-medicine-tab">
                            <div class="dataTables_wrapper pl-0 pr-0">
                                <div class="user-listing-top">
                                    <div class="row mt-4 mt-xxl-0 mb-3 justify-content-start justify-content-xl-end">
                                        <div class="col-12 col-md-8 col-lg-8 col-xl-6 col-xxl-4">
                                    ...
                                    <div class="row align-items-end d-flex mb-3">
                                        <div class="col-12 col-sm-6 col-xl-9 col-xxl-8 mb-3 mb-sm-0 mt-md-0 d-lg-flex d-block align-items-end sort-datepicker flex-wrap flex-xl-nowrap">
                                            <div class="dataTables_length ms-0 ms-xl-0 flex-shrink-0 mt-0 mt-xl-0">
                                        ...
                                        <div class="col-12 col-sm-6 col-xl-3 col-xxl-4 mb-0 mb-lg-0 d-block d-md-flex justify-content-end">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12 col-xxl-5 align-self-center text-center text-xxl-start">
                                        <div class="dataTables_info pl-2">  Showing {{medicine_list.from}} to {{medicine_list.to}} of {{medicine_list.total}} entries</div>
                        ...
                        <div class="tab-pane fade" id="pills-appointment" role="tabpanel" aria-labelledby="pills-appointment-tab">
                            <div class="dataTables_wrapper pl-0 pr-0">
                                <div class="user-listing-top">
                                    <div class="row mt-4 mt-xxl-0 mb-3 mb-xxl-2 justify-content-start justify-content-xl-end">
                                    ...
                                    <div class="row align-items-end d-flex mb-3">
                                        ...
                                        <div class="col-12 col-xl-auto flex-lg-grow-0 sort-datepicker mb-3 mb-xl-0">
                                        ...
                                        <div class="col d-block d-sm-flex justify-content-between flex-grow-1">
                                            <div class="dataTables_length ms-0 ms-xl-0 flex-shrink-0 mb-3 mb-sm-0  text-sm-end text-md-start">
                                                <label class="d-inline-block me-2 flex-shrink-0 text-start">Show</label>
                                                <div class="select-wrapper d-inline-block w-auto flex-grow-1">
                                            ...
                                            <div class="filter-wrap d-md-flex d-block flex-column align-items-end">
                                                <div class="select-wrapper d-block w-auto me-0 mb-0 mb-md-0">
                                ...
                                <div class="main-tabble table-responsive mx-n2">
                                    <table class="table table-borderless dataTable px-2">
                                       ...
                                       <no-record tag="tr" :colspan="10" :data="appointment_list.data" class="col-md-3">
                                       </no-record>
