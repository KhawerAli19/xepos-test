<template>
    <div>
        ...
        <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Ambassadors</h3>
    </div>
    <div class="notification-section shadow p-5 rounded-15 my-4">
        <div class="row">
            <div class="col-md-12 pt-5 table-responsive">
                <Table @page-changed="fetch" :fields="tableFields" :data="ambassadors">
                    <table-search 
                        show-status
                        show-date-ranges
                        ...
                        <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <router-link :to="{ name : 'admin.ambassadors.show',params : {id : item.id} }" class="dropdown-item mb-1"><i class="fa fa-eye "></i>View</router-link>
