    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><router-link :to="{ name: 'admin.configuration.index' , params:{type:'stickers'} }" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i>Edit Stickers</router-link></h3>
            </div>
        </div>
    </div>
                ...
                <form @submit.prevent="handleSubmit(update)">
                    <div class="d-flex mb-3 flex-wrap align-items-center">
                        <div class="labelTitle col-md-6">
                            <p class="mb-0 font-weight-bold">Sticker Name :</p>
                        </div>
                    ...
                    <div class="d-flex mb-3 flex-wrap align-items-center">
                        <div class="labelTitle col-md-6">
                            <p class="mb-0 font-weight-bold">Sticker Image :</p>
                        </div>
                        <div class="fieldData col-md-6">
...
export default {
    ...
    methods: {
        ...
        async fetch(page = 1) {
			let params = {
				route: route('admin.configuration.stickers.show',{id: this.$route.params.id}),
				 data: {
                    page
                }
			};
			let { data } = await this.getAll(params);
            this.form = data.sticker;
		},
        async update() {
            let fd = new FormData();
            ...
            let params = {
                route: route('admin.configuration.stickers.update' , {id: this.$route.params.id}),
                method: 'POST',
                data: fd,
            };
            try {
                ...
                if (data.status) {
                    ...
                    this.$router.push({ name: 'admin.configuration.index' , params:{type:'stickers'} });
