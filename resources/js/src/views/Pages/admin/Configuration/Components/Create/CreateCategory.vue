    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                  <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><router-link :to="{ name: 'admin.configuration.index' , params:{type:'account-category'} }" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i>Add Category</router-link></h3>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async create() {
            ...
            let params = {
                route: route('admin.configuration.category.store'),
                method: 'POST',
                data: fd,
            };
