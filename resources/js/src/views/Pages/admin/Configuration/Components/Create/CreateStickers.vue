    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                 <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><router-link :to="{ name: 'admin.configuration.index' , params:{type:'stickers'} }" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i>Add Sticker</router-link></h3>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async create() {
            ...
            let params = {
                route: route('admin.configuration.stickers.store'),
                method: 'POST',
                data: fd,
            };
            try {
