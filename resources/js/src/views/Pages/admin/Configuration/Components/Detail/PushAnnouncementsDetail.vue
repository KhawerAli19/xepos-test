    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><router-link :to="{ name: 'admin.configuration.index' , params:{type:'push-announcements'} }" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i> View Push Announcements</router-link></h3>
            ...
            <div class="col-md-7 m-auto my-3 pt-3">
                    ...
                    <div class="d-flex mb-3 flex-wrap align-items-center">
                        ...
                        <div class="fieldData col-md-6">
                             ...
                             <img width="300" height="300" :src="`storage/${form.image}`">
                        </div>
                    </div>
